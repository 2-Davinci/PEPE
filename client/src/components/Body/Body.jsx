...
const Body = () => {
  return (
    <div className='flex flex-col justify-center items-center gap-6 h-[100vh] my-20 '>
        ...
        <div className='flex justify-center items-center flex-col md:w-1/2 w-full mx-2 gap-5 '>
            <div className='flex flex-col  items-center justify-center bg-[#033e12] opacity-[1.1]  p-3 text-white rounded-tl-[5px]     rounded-br-[5px]  ' >
